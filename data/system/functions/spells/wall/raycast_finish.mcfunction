...
execute align xyz store result score PosX ScoreSpellWall run data get entity @s Pos[0] 10
execute align xyz store result score PosZ ScoreSpellWall run data get entity @s Pos[2] 10
