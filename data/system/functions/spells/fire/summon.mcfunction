...
execute anchored eyes at @s run summon minecraft:armor_stand ~ ~ ~ {Passengers: [{id: "minecraft:snowball", Invulnerable: true, Silent: true, NoGravity: true, PortalCooldown: 60, Tags: [FireballTrail]}], PortalCooldown: 60, NoGravity: true, Invulnerable: true, Silent: true, Tags: [FireballTracker, Immature], Invisible: false, Small: true, Marker: true}
# うごく
