...
# かくつく
# execute anchored eyes at @s run summon minecraft:snowball ~ ~ ~ { PortalCooldown: 60, NoGravity: true, Invulnerable: true, Silent: true, Tags: [FireballTracker, Immature], HasBeenShot: true }
