...
execute as @s[tag=Matched] run scoreboard players operation @s Relationship = Index Relationship
execute as @s[tag=Matched] run scoreboard players operation @e[tag=Testing,limit=1] Relationship = Index Relationship
execute as @s[tag=Matched] run scoreboard players add Index Relationship 1
